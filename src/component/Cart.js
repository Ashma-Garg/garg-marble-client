...
class Cart extends Component {
    ...
    componentDidMount() {
        ...
        if (customerId) {
            ...
            axios.get(`http://localhost:2409/customer/cart/${customerId}`)
                .then(res => {
                    ...
                    axios.all(res.data.map((cartData) => axios.get(`http://localhost:2409/${cartData.category}/cartInfo/${cartData.productId}`)))
    ...
    autoBagUpdate() {
        ...
        while (l[i]) {
            ...
            axios.post(`http://localhost:2409/customer/cart/updateQuantity`, { customerId, productId, quantity })
                .then(res => {
