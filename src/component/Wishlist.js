...
class Wishlist extends Component{
    ...
    componentDidMount(){
        ...
        axios.get(`http://localhost:2409/customer/wishlist/${customerId}`)
        .then(res=>{
            ...
            axios.all(res.data.map((wishlistData)=>axios.get(`http://localhost:2409/${wishlistData.category}/cartInfo/${wishlistData.productId}`)))
