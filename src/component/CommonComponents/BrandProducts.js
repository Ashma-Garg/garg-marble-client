...
class WashbasinBrand extends Component{
    ...
    //toggle delete modal and also hide product if it is deleted
    ...
    //if changes has been made on backend but not reflected on UI
    notRefreshed(res) {
        this.setState({
            notrefresh: res
        })
    ...
    //when user adds product to their wishlist then show this animation
        ...
        return(
            <div style={{ overflowX: 'hidden' }}>
               ...
               <SideNavbar/>
                ...
                {this.state.isDeleteModalOpen && <DeleteModal category={this.props.match.params.category} DeleteProduct={this.state.DeleteProduct} isModalOpen={this.state.isDeleteModalOpen} toggleDeleteModal={(val) => this.toggleDeleteProductModal(val)}/>}
